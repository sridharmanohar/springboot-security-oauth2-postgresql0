...
public class AuthServerOAuth2Config extends AuthorizationServerConfigurerAdapter {
  ...
  //Uncomment the below accessTokenConverter and tokenStore to enable jwt access token generation
  /*
   * @Bean public JwtAccessTokenConverter accessTokenConverter() {
   * JwtAccessTokenConverter converter = new JwtAccessTokenConverter();
   * converter.setSigningKey("as466gf"); return converter; }
   * 
   ...
   */   
    ...
    //also uncomment the accessTokenConverter method call below to enable jwt access token generation
    @Override
